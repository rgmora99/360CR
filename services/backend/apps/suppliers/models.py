...
class Supplier(models.Model):
    ...
    class Meta:
        ordering = ["legal_name"]
        constraints = [
            models.UniqueConstraint(fields=["organization", "code"], name="uq_supplier_org_code"),
            models.UniqueConstraint(fields=["organization", "tax_id"], condition=~models.Q(tax_id=""), name="uq_supplier_org_tax_id"),
        ]
...
class SupplierContact(models.Model):
    ...
    def __str__(self) -> str:
        return f"{self.supplier_id} - {self.first_name} {self.last_name}".strip()
...
class SupplierAddress(models.Model):
    ...
    def __str__(self) -> str:
        return f"{self.supplier_id} - {self.city}"
